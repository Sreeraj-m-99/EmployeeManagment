...
function Add() {
 ...
 let newunni= unni.slice(0,2)
  ...
  useEffect(()=>{
    ...
    setDesignation(localStorage.getItem('desig'))
  ...
  return (
    <div>
      ...
      <Button variant="primary" type="submit" onClick={(e)=>AddBtn(e)}>
        Update
      </Button>
    </Form></Col>
        </Row>
